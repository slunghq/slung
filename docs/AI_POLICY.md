...
The Slung project has strict rules for AI usage:
...
These rules apply only to outside contributions to Slung. Maintainers
...
Please remember that Slung is maintained by humans.
...
Slung is written with plenty of AI assistance, and many maintainers embrace
